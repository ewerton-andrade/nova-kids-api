...
from db import db
from main.utils import get, hash_pass
from models.user import UserModel
from models.oauth2_client import OAuth2Client
from models.oauth2_auth_code import OAuth2AuthorizationCode
...
class PasswordGrant(grants.ResourceOwnerPasswordCredentialsGrant):
    ...
    def authenticate_user(self, username, password):
        ...
        try:
            ...
            pass_hash=hash_pass(get('password', required=True))
            if user is not None and user.check_password(password, pass_hash):
                return user
        except:
            abort(401, "Check User.")
